...
namespace EdwinTools.Rendering {
    public class GPUParticle : MonoBehaviour {
        ...
        [SerializeField]
        private ParticleMoveType m_moveType;
        ...
        /// </summary>
        [SerializeField]
        private Vector3 m_emitDirection;
        ...
        private void Update() {
            ...
            UpdateKeywords();
            UpdateMeta(deltaTime);//核心更新
            UpdateDisplay(deltaTime);//核心显示
        ...
        private void UpdateMeta(float deltaTime) {
            ...
            // m_metaMaterial.SetTexture(ShaderIDs.DisplayMainTexID, m_particleMetaAttachmentA);
        }
        /// <summary>
        /// 更新显示
        /// </summary>
        ...
        /// 
        /// </summary>
        /// <param name="mapSizeAndNum"></param>
